...
class AddTrainScreen extends StatelessWidget {
  AddTrainScreen({super.key});
  static const routeName = '/special_screen.dart';
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: const Text("Are you sure you want to add this train?"),
                actions: [
                  TextButton(
            ...
            if (value == true) {
              ...
              Provider.of<TrainDummy>(context, listen: false).addTrain(
                tripDate: tripDate,
                ...
                numberOfAvailablePassengers: _passengersNumber,
