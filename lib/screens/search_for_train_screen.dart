...
import '../widgets/train_number_list.dart';
import 'package:provider/provider.dart';
import '../data/train_dummy.dart';

// ignore: must_be_immutable
class SearchForTrainScreen extends StatefulWidget {
  ...
  @override
  State<SearchForTrainScreen> createState() => _SearchForTrainScreenState();
}

class _SearchForTrainScreenState extends State<SearchForTrainScreen> {
  int _trainNumber = 0;
